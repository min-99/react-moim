...
// import { UIStyledComponents } from 'web-sdk-ui';
...
class RootDocument extends Document {
  static async getInitialProps(ctx: DocumentContext) {
    ...
    try {
      ...
      //       sheet.collectStyles(uiSheet.collectStyles(<App {...props} />)),
      //   });
  ...
  render() {
    return (
      <Html>
        <Head>
          <link
            href="//res.edithome.co/web/css/SpoqaHanSansNeo.css"
            rel="stylesheet"
            type="text/css"
          />
          {isDeploy() && (
          ...
          {isDeploy() && process.env.NEXT_PUBLIC_GA_CODE && (
            <>
